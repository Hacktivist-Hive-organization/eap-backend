...
def seed_users(db: Session):
    ...
    motopp_requester_1 = DbUser(
        email="anastasiia.ryzhkova@motopp.nl",
    ...
    motopp_requester_2 = DbUser(
        email="abeer.alkhouri@motopp.nl",
        first_name="Abeer",
        last_name="Alkhouri",
        hashed_password=hash_password("Password123!"),
        role=UserRole.REQUESTER,
    ...
    motopp_requester_3 = DbUser(
        email="oleksii.pokormiakho@motopp.nl",
        first_name="Oleksii",
        last_name="Pokormiakho",
        hashed_password=hash_password("Password123!"),
        role=UserRole.REQUESTER,
        is_active=True,
    )

    motopp_requester_4 = DbUser(
        email="reema.alshohof@motopp.nl",
        first_name="Reema",
        last_name="Alshohof",
        hashed_password=hash_password("Password123!"),
        role=UserRole.REQUESTER,
    ...
    motopp_requester_5 = DbUser(
        email="yuval.hashmonay@motopp.nl",
        first_name="Yuval",
        last_name="Hashmonay",
        hashed_password=hash_password("Password123!"),
        role=UserRole.REQUESTER,
